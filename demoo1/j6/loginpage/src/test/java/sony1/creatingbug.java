...
//create
		...
		Thread.sleep(3000);
//bug
		WebElement multiListBox1=driver.findElement(By.xpath("//span[@class='icon aui-ss-icon noloading drop-menu']"));
		Select dropdown1 = new Select(multiListBox1);
...
//Linked Issue
Thread.sleep(3000);
WebElement multiListBox=driver.findElement(By.xpath("//*[@id='issuelinks-linktype']"));
Select dropdown = new Select(multiListBox);
